...
from .ahrefs_pages import SITE_EXPLORER_PAGE
...
def scrape_backlinks(url, username, user_agent, logger, *args, **kwargs):
    ...
    while True:
        # Query URL
        query_url = f"{SITE_EXPLORER_PAGE}/backlinks/v7/external-similar-links/{mode}/live/en/all/dofollow/{current_page}/ahrefs_rank_desc?target={protocol}{url}"
